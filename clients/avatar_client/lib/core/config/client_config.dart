class ClientConfig {
  const ClientConfig({required this.coreBaseUrl, required this.avatarRenderer, this.clientToken, this.wakeWordEnabled = false, this.wakeWordEngine = 'openwakeword', this.wakeWordModelAsset = 'wake_word/development/hey_jarvis.onnx', this.wakeWordThreshold = .5});
  ...
  factory ClientConfig.fromEnvironment() {
    ...
    const wakeEngine = String.fromEnvironment('JARVIS_WAKE_WORD_ENGINE', defaultValue: 'openwakeword');
    ...
    return ClientConfig(
      ...
      wakeWordModelAsset: wakeModel,
      wakeWordThreshold: wakeThreshold,
    );
  }
}
